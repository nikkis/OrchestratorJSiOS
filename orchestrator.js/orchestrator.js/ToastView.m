...
const float TOAST_DURATION_LONG  = 5.0;
const float TOAST_DURATION_SHORT = 2.0;
...
+ (void)showToastInParentView: (UIView *)parentView withText:(NSString *)text withDuaration:(float)duration;
{
    ...
    float yOrigin = parentFrame.size.height - (170.0 + ToastHeight * toastsAlreadyInParent + ToastGap * toastsAlreadyInParent);
