...
- (void) onHeartbeat:(SocketIOPacket *)packet
{
    if ([_delegate respondsToSelector:@selector(socketIO:socketIODidReceiveHeartbeat:)]) {
        [_delegate socketIO:self socketIODidReceiveHeartbeat:packet];
    }
}
